            ...
            <form method="POST" action="{{ route('locations.update', $location) }}">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="4" class="block mt-1 w-full border-gray-300 focus:border-primary focus:ring-primary rounded-md shadow-sm">{{ old('description', $location->description) }}</textarea>
